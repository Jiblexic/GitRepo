			...
			return this.each(function() {
				...
				$.getJSON("https://www.api.tweecool.com/?screenname=" + o.username + "&count=" + o.limit, function(data) {
					...
					$.each(data.tweets, function(i, field) {
						...
						wInner.append('' + '<div class="tweets_txt">' + mtext.replace(urlpattern, '<a href="$1" target="_blank">$1</a>').replace(usernamepattern, '<a href="https://twitter.com/$1" target="_blank">@$1</a>').replace(hashpattern, '<a href="https://twitter.com/search?q=%23$1" target="_blank">#$1</a>') + media + ' <br><span>' + timestamp + '  - <a href="https://twitter.com/' + o.username + '">@' + o.username  + '</a></span>'+abox+'</div>');
					});
